...
public class CollectionsUtil
{
    ...
    /**
     * @return a comparator that provides the natural ordering (i.e. the order
     *         defined by T.compareTo(T)
     */
     ...
     *            the source map
     * @param comparator
     *            the desired order for the entries list
     * 
    ...
    /**
     * Creates a list of sorted entries by copying them from the entrySet of a
     * map. They are sorted by the natural order of the key (defined by
     * K.compareTo(K))
     * 
     * @param map
     *            the source map
    ...
    /**
     * given a map of ? -> Integer counting occurrences, this adds one to the
     * occurrence
     * 
     * @param <T>
     * @param map
