...
public interface CharTermAttribute extends Attribute, CharSequence, Appendable
{
    ...
    /**
     * Copies the contents of buffer, starting at offset for length characters,
     ...
     * directly alter. If the array is too small for your token, use
     * {@link #resizeBuffer(int)} to increase it. After altering the buffer be
     * sure to call {@link #setLength} to record the number of valid characters
     ...
     * array, use {@link #resizeBuffer(int)} first.
     * 
     * @param length
    ...
    /**
     * Sets the length of the termBuffer to zero. Use this method before
     * appending contents using the {@link Appendable} interface.
     */
     ...
     * <p>
     * The characters of the {@code StringBuilder} argument are appended, in
     * order, increasing the length of this sequence by the length of the
     * argument. If argument is {@code null}, then the four characters
     ...
     * character sequence.
     * <p>
     * The characters of the {@code CharTermAttribute} argument are appended, in
     * order, increasing the length of this sequence by the length of the
     * argument. If argument is {@code null}, then the four characters
     * {@code "null"} are appended.
     */
